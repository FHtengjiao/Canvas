...
<div class="main">
    ...
    <div class="agileinfo_404_main">
        <h1>Inner Server Error Page</h1>
        <div class="w3_agile_main">
            <h2>Server Error Occurred</h2>
            <p>For some reason the Server can't operate your request.</p>
            <div class="agile_404 w3layouts">
                <div class="agile_404_pos">
                    <h3>5<span>0</span><span>0</span><img src="../../../lib/img/1.png" alt=" " /> </h3>
                </div>
                <img src="../../../lib/img/3.png" alt=" " class="w3l"/>
            </div>
        </div>
        ...
        <div class="agileits_copyright">
            <p>Copyright &copy; 2018.慕课网(imooc) All rights reserved.</p>
        </div>
    </div>
</div>
